...
indic.codes <- c("SP.DYN.IMRT.IN", "SH.STA.OWAD.ZS","SH.MED.BEDS.ZS", "SH.XPD.CHEX.GD.ZS", "BX.KLT.DINV.CD.WD",
                 "EN.FSH.THRD.NO", "ER.FSH.PROD.MT","IT.NET.BBND.P2", "IT.NET.USER.ZS", "SE.XPD.TOTL.GD.ZS",
                 "NV.AGR.EMPL.KD", "SL.EMP.TOTL.SP.NE.ZS", "NV.AGR.TOTL.ZS", "EN.ATM.CO2E.PC",
                 "NE.EXP.GNFS.ZS", "BX.KLT.DINV.WD.GD.ZS", "AG.LND.FRST.ZS", "NY.GDP.MKTP.KD.ZG",
                 "NY.GDP.PCAP.PP.KD", "SL.GDP.PCAP.EM.KD", "ST.INT.RCPT.XP.ZS",
                 "SP.DYN.LE00.IN", "NV.IND.MANF.ZS", "NV.IND.MANF.CD", "ER.MRN.PTMR.ZS",
                 "SH.DYN.NCOM.ZS", "SI.POV.UMIC", "SE.PRE.ENRR", "SE.TER.ENRR",
                 "SE.PRM.TCAQ.ZS", "SE.SEC.TCAQ.ZS", "SL.UEM.TOTL.NE.ZS", "NE.EXP.GNFS.CD",
                 "BX.KLT.DINV.CD.WD", "ST.INT.RCPT.CD", "NV.AGR.TOTL.CD", "SL.UEM.TOTL.FE.NE.ZS",
                 "SL.EMP.TOTL.SP.FE.NE.ZS", "SH.DYN.NMRT", "SH.XPD.OOPC.CH.ZS", "SH.STA.MMRT",
                 "EN.ATM.GHGT.KT.CE", "ST.INT.ARVL")
...
final_values <- rbind(eccb_values, wdi_values, comtrade_values, unodc_values, who_values, irena_values)
...
unique(final_values_cleaned$variable)
...
write_csv(final_values_cleaned, paste0("data/oecs_data_", format(Sys.Date(), "%B_%Y"), ".csv"))
